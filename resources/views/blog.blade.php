...
<head>
  <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=cmd1.0" name="viewport">

  <title>Blog TG CREATIVE</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">TG CREATIVE</a></h1>
  ...
  <footer id="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <div class="social-links mt-3">
                <a href="https://www.instagram.com/tgcreative.id/" class="instagram"><i class="bx bxl-instagram"></i></a>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">WIBI.TRi GUNTORO.SANTIKO</a>
      </div>
    </div>
  </footer><!-- End Footer -->
